...
class WrapperDataset(Dataset):
    ...
    def modify_output(self, original_item):
        ...
        fovy = noised_cameras["FoVy"]
        fovx = noised_cameras["FoVx"]
        full_proj_transform = noised_cameras["full_proj_transform"]
        world_view_transform = noised_cameras["world_view_transform"]
        camera_center = noised_cameras["camera_center"]
