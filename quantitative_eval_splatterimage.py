...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='/scratch/paul/generative-splatting/data/converted/mvimgnet')
    parser.add_argument('--dataset_classes', type=str, nargs='+', default=['*'])
    parser.add_argument('--dataset_suffix', type=str, default='256')
    parser.add_argument('--ckpt_dir', type=str, default='/home/melonie/si_my/experiments_out/2024-05-18/18-50-31')
    ...
    parser.add_argument('--perm', type=str, default="middle")
